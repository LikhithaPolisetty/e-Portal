...
import {
    login, logout, setDefaultClient, deleteClient, setDefaultEmployee, setDefaultVendor, setTabnerClients, setTabnerEmployees,
    setTabnerVendors
...
class Clients extends Component {
    ...
    handleCreateClient(event){
        ...
        axios.post('http://localhost:8080/TabnerEmployeePayroll/newclient', {
    ...
    onClientSelect(index){
            ...
            if(alert_msg) {
                ...
                axios.post('http://localhost:8080/TabnerEmployeePayroll/deleteclient', {
